...
MundoTexto criarMundoVila() {
  final salas = {
    ...
    'mercado': Sala(
      ...
      descricao: 'Comida, armas, poções. Lugar de comércio.',
      saidas: {
        'oeste': 'praca',
        'norte': 'cripta',
      },
    ...
    'portao': Sala(
      id: 'portao',
      nome: 'Portão da Vila',
      descricao: 'Entrada fortificada. Campos se estendem além.',
      saidas: {
        'norte': 'praca',
      },
    ),
    ...
    'caverna': Sala(
      ...
      descricao: 'Escura demais. Respiração quente ao longe.',
      saidas: {
        'sul': 'floresta',
      },
      inimigoPresente: Orc(),
