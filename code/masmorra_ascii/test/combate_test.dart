import 'package:masmorra_ascii/src/ia/estado_ia.dart';
import 'package:masmorra_ascii/src/combate/combate.dart';
import 'package:masmorra_ascii/src/modelos/inimigo.dart';
import 'package:masmorra_ascii/src/modelos/jogador.dart';
...
void main() {
  group('executarCombate', () {
    ...
    setUp(() {
      jogador = Jogador(nome: 'Herói', hp: 20);
      logs = [];
    });
    ...
    test('combate termina quando HP do jogador chega a 0', () {
      final inimigo = Esqueleto(); // dano = 3
      jogador.hp = 1;
    ...
    test('FSM: inimigo com HP ≤25% transita para Fugindo', () {
      final inimigo = Esqueleto(); // hpMax 8
      inimigo.hp = 2;
      inimigo.estado = Atacando();
      final alvo = Jogador(nome: 'Herói', hp: 50);
    ...
    test('defesa do jogador reduz dano do ataque do inimigo', () {
      final inimigo = Esqueleto(); // ataque 3
      final alvo = Jogador(nome: 'Herói', hp: 20, defesa: 2);
      inimigo.executarTurno(alvo, logs.add);
